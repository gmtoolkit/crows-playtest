...
CROWS.traitTrees = {
  alchemy: { label: "CROWS.TreeAlchemy", spec: "CROWS.TreeSpec.Alchemy" },
  alteration: { label: "CROWS.TreeAlteration", spec: "CROWS.TreeSpec.Alteration" },
  archery: { label: "CROWS.TreeArchery", spec: "CROWS.TreeSpec.Archery" },
  armor: { label: "CROWS.TreeArmor", spec: "CROWS.TreeSpec.Armor" },
  bashing: { label: "CROWS.TreeBashing", spec: "CROWS.TreeSpec.Bashing" },
  benefaction: { label: "CROWS.TreeBenefaction", spec: "CROWS.TreeSpec.Benefaction" },
  blacksmithing: { label: "CROWS.TreeBlacksmithing", spec: "CROWS.TreeSpec.Blacksmithing" },
  camping: { label: "CROWS.TreeCamping", spec: "CROWS.TreeSpec.Camping" },
  chopping: { label: "CROWS.TreeChopping", spec: "CROWS.TreeSpec.Chopping" },
  conjuration: { label: "CROWS.TreeConjuration", spec: "CROWS.TreeSpec.Conjuration" },
  elemental: { label: "CROWS.TreeElemental", spec: "CROWS.TreeSpec.Elemental" },
  enchantment: { label: "CROWS.TreeEnchantment", spec: "CROWS.TreeSpec.Enchantment" },
  illusion: { label: "CROWS.TreeIllusion", spec: "CROWS.TreeSpec.Illusion" },
  knowledge: { label: "CROWS.TreeKnowledge", spec: "CROWS.TreeSpec.Knowledge" },
  leverage: { label: "CROWS.TreeLeverage", spec: "CROWS.TreeSpec.Leverage" },
  necromancy: { label: "CROWS.TreeNecromancy", spec: "CROWS.TreeSpec.Necromancy" },
  pets: { label: "CROWS.TreePets", spec: "CROWS.TreeSpec.Pets" },
  reputation: { label: "CROWS.TreeReputation", spec: "CROWS.TreeSpec.Reputation" },
  slashing: { label: "CROWS.TreeSlashing", spec: "CROWS.TreeSpec.Slashing" },
  stabbing: { label: "CROWS.TreeStabbing", spec: "CROWS.TreeSpec.Stabbing" },
  thievery: { label: "CROWS.TreeThievery", spec: "CROWS.TreeSpec.Thievery" },
  travel: { label: "CROWS.TreeTravel", spec: "CROWS.TreeSpec.Travel" },
  unarmed: { label: "CROWS.TreeUnarmed", spec: "CROWS.TreeSpec.Unarmed" }
};
...
/**
 * Art shipped with the system.
 *
 * Regenerated by `node tools/make-token-art.mjs`; the SVG sources sit beside
 * the webp so a colour can be changed without an image editor.
 */
CROWS.art = {
  crowToken: "systems/crows/assets/tokens/crow.webp",
  crowDeadToken: "systems/crows/assets/tokens/crow-dead.webp",
  humanToken: "systems/crows/assets/tokens/human.webp",
  hostileToken: "systems/crows/assets/tokens/hostile.webp"
};
